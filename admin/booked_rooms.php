...
if(isset($_GET['delete'])){
   ...
   if($delete_query){
      echo "<script type = \"text/javascript\">
                           ...
                           window.location = (\"booked_rooms.php\")
									</script>";
   }else{
      echo "<script type = \"text/javascript\">
   ...
   <table align="center">
      ...
      <tbody class="white">
         ...
         <tr>
            ...
            <td>
               <a href="booked_rooms.php?delete=<?php echo $row['id']; ?>" class="btn" onclick="return confirm('are your sure you want to delete this room?');"> <i class="fas fa-trash"></i> DELETE </a>
               <a href="booked_rooms.php?edit=<?php echo $row['id']; ?>" class="btn"> <i class="fas fa-edit"></i> UPDATE </a>
            </td>
         </tr>
...
<section>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="button" value="cancel" onClick="document.location.href='booked_rooms.php';" />
   </form>
